...
public class LoginAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("AdminData", Context.MODE_PRIVATE);
    }
    ...
    protected void onStart() {
        ...
        unverifiedOrganizationsIntent = new Intent(this, OneUnverifiedOrganizationActivity.class);
    }
    ...
    private void login() {
        if (editName.getText().toString().isEmpty() || editPassword.getText().toString().isEmpty()) {
            Toast.makeText(LoginAdminActivity.this, "Логин или пароль указан неверно", Toast.LENGTH_SHORT).show();
        } else {
            ...
            call.enqueue(new Callback<LoginResponse>() {
                ...
                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                    if (response.isSuccessful()) {
                        ...
                        startActivity(unverifiedOrganizationsIntent);
                    } else {
                        ...
                        Toast.makeText(LoginAdminActivity.this, "Данные недействительны", Toast.LENGTH_SHORT).show();
                    }
